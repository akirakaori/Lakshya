...
export const PaginationControls: React.FC<PaginationControlsProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-4 border border-[#E5E7EB] bg-white px-4 py-4 sm:flex-row">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="border border-[#D1D5DB] bg-white px-3 py-2 text-[13px] font-medium text-[#374151] transition-colors hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-white"
        >
          Previous
        </button>
        ...
        <div className="hidden items-center gap-1 sm:flex">
          {getPageNumbers().map((pageNum, index) => (
            pageNum === '...' ? (
              <span key={`ellipsis-${index}`} className="px-3 py-2 text-[13px] text-[#6B7280]">
                ...
              </span>
            ) : (
              <button
                ...
                className={`border px-3 py-2 text-[13px] font-medium transition-colors ${
                  page === pageNum
                    ...
                    : 'border-[#D1D5DB] bg-white text-[#374151] hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50'
                }`}
              >
                {pageNum}
              </button>
