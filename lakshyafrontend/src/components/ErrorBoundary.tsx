...
class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="rounded-xl border border-red-200 bg-white p-6 dark:border-red-500/20 dark:bg-slate-900">
            ...
            <div className="flex-1">
              ...
              {this.state.error && (
                <details className="mt-2">
                  ...
                  <pre className="mt-2 max-h-32 overflow-auto rounded bg-red-50 p-2 text-xs text-red-600 dark:bg-red-500/10 dark:text-red-300">
